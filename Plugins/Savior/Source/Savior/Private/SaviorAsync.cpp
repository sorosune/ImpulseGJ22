...
USAVIOR_OpenLevel* USAVIOR_OpenLevel::OpenLevel(UObject* Context, AHUD_SaviorUI* HUD, USavior* Slot, TSoftObjectPtr<UWorld>LevelToOpen) {
	...
	if (Slot) {
		if (!Slot->IsInstance()||(Slot->IsInstance()&&(Slot->GetThreadSafety()!=EThreadSafety::IsCurrentlyThreadSafe))) {
			OBJ->Target = USavior::NewSlotInstance(Context,Slot,Result);
...
USAVIOR_OpenLevel_Callback* USAVIOR_OpenLevel_Callback::OpenLevel(UObject* Context, AHUD_SaviorUI* HUD, USavior* Slot, TSoftObjectPtr<UWorld>LevelToOpen, const FBeginDATA &OnOpenCallback) {
...
USAVIOR_SaveGameWorld_Callback* USAVIOR_SaveGameWorld_Callback::SaveGameWorld(USavior* Savior, UObject* Context, const bool SaveSlotMeta, const FBeginDATA &BeganSaveCallback, const FEndDATA &FinishedSaveCallback) {
...
USAVIOR_LoadGameWorld* USAVIOR_LoadGameWorld::LoadGameWorld(USavior* Savior, UObject* Context, const bool ResetLevelOnLoad) {
...
USAVIOR_LoadGameWorld_Callback* USAVIOR_LoadGameWorld_Callback::LoadGameWorld(USavior* Savior, UObject* Context, const bool ResetLevelOnLoad, const FBeginDATA &BeganLoadCallback, const FEndDATA &FinishedLoadCallback) {
...
USAVIOR_SaveLevel* USAVIOR_SaveLevel::SaveLevel(USavior* Savior, TSoftObjectPtr<UWorld>LevelToSave, UObject* Context, const bool SaveSlotMeta, const bool WriteSlotFile) {
...
USAVIOR_SaveLevel_Callback* USAVIOR_SaveLevel_Callback::SaveLevel(USavior* Savior, TSoftObjectPtr<UWorld>LevelToSave, UObject* Context, const bool SaveSlotMeta, const bool WriteSlotFile, const FBeginDATA &BeganSaveCallback, const FEndDATA &FinishedSaveCallback) {
...
USAVIOR_LoadLevel* USAVIOR_LoadLevel::LoadLevel(USavior* Savior, TSoftObjectPtr<UWorld>LevelToLoad, UObject* Context, const bool StreamLevelOnLoad, const bool ReadSlotFile) {
...
USAVIOR_LoadLevel_Callback* USAVIOR_LoadLevel_Callback::LoadLevel(USavior* Savior, TSoftObjectPtr<UWorld>LevelToLoad, UObject* Context, const bool StreamLevelOnLoad, const bool ReadSlotFile, const FBeginDATA &BeganLoadCallback, const FEndDATA &FinishedLoadCallback) {
...
USAVIOR_SaveGameMode* USAVIOR_SaveGameMode::SaveGameMode(USavior* Savior, UObject* Context, const bool SaveSlotMeta, const bool WithGameInstance) {
...
USAVIOR_SaveGameMode_Callback* USAVIOR_SaveGameMode_Callback::SaveGameMode(USavior* Savior, UObject* Context, const bool SaveSlotMeta, const bool WithGameInstance, const FBeginDATA &BeganSaveCallback, const FEndDATA &FinishedSaveCallback) {
...
USAVIOR_LoadGameMode* USAVIOR_LoadGameMode::LoadGameMode(USavior* Savior, UObject* Context, const bool IgnoreMainPawnTransform, const bool WithGameInstance) {
...
USAVIOR_LoadGameMode_Callback* USAVIOR_LoadGameMode_Callback::LoadGameMode(USavior* Savior, UObject* Context, const bool IgnoreMainPawnTransform, const bool WithGameInstance, const FBeginDATA &BeganLoadCallback, const FEndDATA &FinishedLoadCallback) {
...
USAVIOR_SaveGameInstance* USAVIOR_SaveGameInstance::SaveGameInstance(USavior* Savior, UObject* Context, const bool SaveSlotMeta) {
...
USAVIOR_SaveGameInstance_Callback* USAVIOR_SaveGameInstance_Callback::SaveGameInstance(USavior* Savior, UObject* Context, const bool SaveSlotMeta, const FBeginDATA &BeganSaveCallback, const FEndDATA &FinishedSaveCallback) {
...
USAVIOR_LoadGameInstance_Callback* USAVIOR_LoadGameInstance_Callback::LoadGameInstance(USavior* Savior, UObject* Context, const FBeginDATA &BeganLoadCallback, const FEndDATA &FinishedLoadCallback) {
