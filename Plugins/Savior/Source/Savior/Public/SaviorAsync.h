...
class SAVIOR_API USAVIOR_OpenLevel : public UBlueprintAsyncActionBase {
	GENERATED_BODY()
private:
	UPROPERTY() AHUD_SaviorUI* SHUD;
	UPROPERTY() USavior* Target;
...
public:
	...
	static USAVIOR_OpenLevel* OpenLevel(UObject* Context, AHUD_SaviorUI* HUD, USavior* Slot, TSoftObjectPtr<UWorld>LevelToOpen);
};
...
UCLASS(meta=(HideThen=true))
class SAVIOR_API USAVIOR_OpenLevel_Callback : public UBlueprintAsyncActionBase {
	GENERATED_BODY()
private:
...
public:
	...
	static USAVIOR_OpenLevel_Callback* OpenLevel(UObject* Context, AHUD_SaviorUI* HUD, USavior* Slot, TSoftObjectPtr<UWorld>LevelToOpen, const FBeginDATA &OnOpenCallback);
};
...
UCLASS(meta=(HideThen=true))
class SAVIOR_API USAVIOR_SaveGameWorld : public UBlueprintAsyncActionBase {
	GENERATED_BODY()
private:
	UPROPERTY() USavior* Target;
	UPROPERTY() UObject* Outer;
...
UCLASS(meta=(HideThen=true))
class SAVIOR_API USAVIOR_SaveGameWorld_Callback : public UBlueprintAsyncActionBase {
	GENERATED_BODY()
private:
...
public:
	...
	static USAVIOR_SaveGameWorld_Callback* SaveGameWorld(USavior* Savior, UObject* Context, const bool SaveSlotMeta, const FBeginDATA &BeganSaveCallback, const FEndDATA &FinishedSaveCallback);
};
...
UCLASS(meta=(HideThen=true))
class SAVIOR_API USAVIOR_LoadGameWorld : public UBlueprintAsyncActionBase {
	GENERATED_BODY()
private:
	UPROPERTY() USavior* Target;
	UPROPERTY() UObject* Outer;
...
public:
	...
	static USAVIOR_LoadGameWorld* LoadGameWorld(USavior* Savior, UObject* Context, const bool ResetLevelOnLoad);
};
...
UCLASS(meta=(HideThen=true))
class SAVIOR_API USAVIOR_LoadGameWorld_Callback : public UBlueprintAsyncActionBase {
	GENERATED_BODY()
private:
...
public:
	...
	static USAVIOR_LoadGameWorld_Callback* LoadGameWorld(USavior* Savior, UObject* Context, const bool ResetLevelOnLoad, const FBeginDATA &BeganLoadCallback, const FEndDATA &FinishedLoadCallback);
};
...
UCLASS(meta=(HideThen=true))
class SAVIOR_API USAVIOR_SaveLevel : public UBlueprintAsyncActionBase {
	GENERATED_BODY()
private:
...
public:
	...
	static USAVIOR_SaveLevel* SaveLevel(USavior* Savior, TSoftObjectPtr<UWorld>LevelToSave, UObject* Context, const bool SaveSlotMeta=true, const bool WriteSlotFile=true);
};
...
UCLASS(meta=(HideThen=true))
class SAVIOR_API USAVIOR_SaveLevel_Callback : public UBlueprintAsyncActionBase {
	GENERATED_BODY()
private:
	UPROPERTY()	FEndDATA FinishedSave;
	UPROPERTY()	FBeginDATA BeganSave;
...
public:
	...
	static USAVIOR_SaveLevel_Callback* SaveLevel(USavior* Savior, TSoftObjectPtr<UWorld>LevelToSave, UObject* Context, const bool SaveSlotMeta, const bool WriteSlotFile, const FBeginDATA &BeganSaveCallback, const FEndDATA &FinishedSaveCallback);
};
...
UCLASS(meta=(HideThen=true))
class SAVIOR_API USAVIOR_LoadLevel : public UBlueprintAsyncActionBase {
	GENERATED_BODY()
private:
	UPROPERTY() TSoftObjectPtr<UWorld>Level;
	UPROPERTY() USavior* Target;
...
public:
	...
	static USAVIOR_LoadLevel* LoadLevel(USavior* Savior, TSoftObjectPtr<UWorld>LevelToLoad, UObject* Context, const bool StreamLevelOnLoad=true, const bool ReadSlotFile=true);
};
...
UCLASS(meta=(HideThen=true))
class SAVIOR_API USAVIOR_LoadLevel_Callback : public UBlueprintAsyncActionBase {
	GENERATED_BODY()
private:
	UPROPERTY()	FEndDATA FinishedLoad;
	UPROPERTY()	FBeginDATA BeganLoad;
...
public:
	...
	static USAVIOR_LoadLevel_Callback* LoadLevel(USavior* Savior, TSoftObjectPtr<UWorld>LevelToLoad, UObject* Context, const bool StreamLevelOnLoad, const bool ReadSlotFile, const FBeginDATA &BeganLoadCallback, const FEndDATA &FinishedLoadCallback);
};
...
UCLASS(meta=(HideThen=true))
class SAVIOR_API USAVIOR_SaveGameMode : public UBlueprintAsyncActionBase {
	GENERATED_BODY()
private:
	UPROPERTY() UObject* Outer;
	UPROPERTY() USavior* Target;
...
public:
	...
	static USAVIOR_SaveGameMode* SaveGameMode(USavior* Savior, UObject* Context, const bool SaveSlotMeta=true, const bool WithGameInstance=true);
};
...
UCLASS(meta=(HideThen=true))
class SAVIOR_API USAVIOR_SaveGameMode_Callback : public UBlueprintAsyncActionBase {
	GENERATED_BODY()
private:
	UPROPERTY()	FBeginDATA BeganSave;
	UPROPERTY()	FEndDATA FinishedSave;
...
public:
	...
	static USAVIOR_SaveGameMode_Callback* SaveGameMode(USavior* Savior, UObject* Context, const bool SaveSlotMeta, const bool WithGameInstance, const FBeginDATA &BeganSaveCallback, const FEndDATA &FinishedSaveCallback);
};
...
UCLASS(meta=(HideThen=true))
class SAVIOR_API USAVIOR_LoadGameMode : public UBlueprintAsyncActionBase {
	GENERATED_BODY()
private:
	UPROPERTY() UObject* Outer;
	UPROPERTY() USavior* Target;
...
public:
	...
	static USAVIOR_LoadGameMode* LoadGameMode(USavior* Savior, UObject* Context, const bool IgnoreMainPawnTransform, const bool WithGameInstance=true);
};
...
UCLASS(meta=(HideThen=true))
class SAVIOR_API USAVIOR_LoadGameMode_Callback : public UBlueprintAsyncActionBase {
	GENERATED_BODY()
private:
	UPROPERTY()	FBeginDATA BeganLoad;
	UPROPERTY()	FEndDATA FinishedLoad;
...
public:
	...
	static USAVIOR_LoadGameMode_Callback* LoadGameMode(USavior* Savior, UObject* Context, const bool IgnoreMainPawnTransform, const bool WithGameInstance, const FBeginDATA &BeganLoadCallback, const FEndDATA &FinishedLoadCallback);
};
...
UCLASS(meta=(HideThen=true))
class SAVIOR_API USAVIOR_SaveGameInstance : public UBlueprintAsyncActionBase {
	GENERATED_BODY()
private:
	UPROPERTY() USavior* Target;
	UPROPERTY() UObject* Outer;
...
public:
	...
	static USAVIOR_SaveGameInstance* SaveGameInstance(USavior* Savior, UObject* Context, const bool SaveSlotMeta=true);
};
...
UCLASS(meta=(HideThen=true))
class SAVIOR_API USAVIOR_SaveGameInstance_Callback : public UBlueprintAsyncActionBase {
	GENERATED_BODY()
private:
	UPROPERTY()	FEndDATA FinishedSave;
	UPROPERTY()	FBeginDATA BeganSave;
...
public:
	...
	static USAVIOR_SaveGameInstance_Callback* SaveGameInstance(USavior* Savior, UObject* Context, const bool SaveSlotMeta, const FBeginDATA &BeganSaveCallback, const FEndDATA &FinishedSaveCallback);
};
...
UCLASS(meta=(HideThen=true))
class SAVIOR_API USAVIOR_LoadGameInstance : public UBlueprintAsyncActionBase {
	GENERATED_BODY()
private:
	UPROPERTY() USavior* Target;
	UPROPERTY() UObject* Outer;
...
UCLASS(meta=(HideThen=true))
class SAVIOR_API USAVIOR_LoadGameInstance_Callback : public UBlueprintAsyncActionBase {
	GENERATED_BODY()
private:
	UPROPERTY()	FEndDATA FinishedLoad;
	UPROPERTY()	FBeginDATA BeganLoad;
...
public:
	...
	static USAVIOR_LoadGameInstance_Callback* LoadGameInstance(USavior* Savior, UObject* Context, const FBeginDATA &BeganLoadCallback, const FEndDATA &FinishedLoadCallback);
};
